namespace ZestGames
{
    public class Enums
    {
        ...
        public enum PoolStamp { Something, MoneyCollect2D, MoneySpend2D, HitBoxEffect, HitBoxSmokeSquare, HitBoxSmoke, MoneyTextDisplay, ExplosionLargeEffect, VFX_Voxel_Stone, VFX_Voxel_Copper, VFX_Voxel_Diamond, Debris_Stone, Debris_Copper, Debris_Diamond, VFX_Chest_Break, CharacterPop_Confetti, CoinCollect2D, ShopCoinCollect2D }
        public enum PrefabStamp { StoneBox, StaticBox, PushableBox, ExplosiveBox, MiddleBox, LevelEndBox, BorderBox, CopperBox, DiamondBox, ChestPickaxeDurability, ChestPickaxeSpeed, CollectableInfoPopup }
        public enum AudioType { Testing_PlayerMove, Button_Click, UpgradeMenu, CollectMoney, SpendMoney, HitBox, HitExplosive, Land, Swing, BreakBox, PushBox, PushBoxDrop, HitChest, ChestOpen, BreakChest, CharacterPop, CollectCoin }
