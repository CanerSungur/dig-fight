...
namespace DigFight
{
    public class Box : MonoBehaviour, IHealth, IDamageable
    {
        //[Header("-- SETUP --")]
        ...
        #region PROPERTIES
        public int MaxHealth => DEFAULT_HP;
        ...
        public void GetDamaged(int amount)
        {
            ...
            //hitSmokePS.Play();
            PoolManager.Instance.SpawnFromPool(Enums.PoolStamp.HitBoxSmoke, transform.position, Quaternion.identity);
